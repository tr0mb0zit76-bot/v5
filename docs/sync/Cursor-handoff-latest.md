...
| Коммит | Суть |
| --- | --- |
| _(этот push)_ | **Матчинг управленки:** короткие имена контрагентов (СКЛ), формат «СКЛ ООО» из выписки; relaxed-поиск по перевозчику для **исходящих** платежей; приоритет «контрагент в назначении» над «только сумма» |
