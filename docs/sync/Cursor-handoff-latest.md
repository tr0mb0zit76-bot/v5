...
**Обновлено:** 2026-08-17 19:30 · **Ветка:** `master` · **тема:** инструкция по лидам для менеджера

### Итог сессии 2026-08-17 — лиды, инструкция

| Блок | Статус |
| --- | --- |
| `docs/lead-user-guide.md` — переписана с упором на выгоду менеджера + актуальный UI | ✅ |
...
| Книга продаж локально (статья id=9 по title) | ✅ `php scripts/sync-leads-sales-book-article.php` |
| Книга продаж **prod** (id=19) | ⏳ после `git pull` на сервере тот же скрипт |

**Следующий шаг:** закоммитить доки; на проде после выкладки кода прогнать `php scripts/sync-leads-sales-book-article.php`.
