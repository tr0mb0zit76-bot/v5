...
**Обновлено:** 2026-09-01 16:25 (ОТДАТЬ + деплой) · **Ветка:** `master` · **HEAD:** `c3bf57a4` (feat `62728df3`) · **тема:** «Сколько влезет?» — сравнение до 10 видов транспорта + доступ менеджерам
