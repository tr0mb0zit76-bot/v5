...
- [ ] Appearance подписи: текст/штамп в прямоугольнике (не исчезает при правке в Acrobat — ограничение PDF)
...
| v0.3.2 | 2026-06-15 | Бэклог: несколько точек выгрузки у перевозчика — в печатную форму попадает только последняя |
