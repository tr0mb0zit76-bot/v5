...
- [ ] Scheduler 10:00 и 16:00 (MSK, настраиваемо)
- [ ] Задача менеджерам с незаполненным утренним/вечерним слотом за текущий период
- [ ] Автозакрытие задачи при сохранении соответствующей ячейки
- [ ] Badge в cabinet notifications
...
- [ ] `OrderActivityTimelineService` — статусы, документы, задачи, письма, комментарии, **записи диспозиции**
- [ ] Вкладка в wizard заказа (по аналогии с `ActivityTimeline` у лида)
...
- [ ] Задачи 2×/день, timeline-комментарии ← **следующий шаг P0+**
