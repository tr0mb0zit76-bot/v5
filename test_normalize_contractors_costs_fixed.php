...
$result1 = $controller->normalizeContractorsCosts($order1, $financialTerm1);
...
$result2 = $controller->normalizeContractorsCosts($order2, $financialTerm2);
...
$result3 = $controller->normalizeContractorsCosts($order3, $financialTerm3);
...
$result4 = $controller->normalizeContractorsCosts($order4, $financialTerm4);
...
$result5 = $controller->normalizeContractorsCosts($order5, $financialTerm5);
