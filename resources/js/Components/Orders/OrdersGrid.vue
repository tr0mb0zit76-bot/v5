      ...
      <div class="flex items-center gap-2">
        <div class="relative">
          <input
            ...
            class="w-64 rounded-xl border border-zinc-200 bg-white px-3 py-1.5 text-sm outline-none focus:border-zinc-900 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:border-zinc-50"
          />
        </div>
...
import { RotateCcw, Rows3, Settings2, X } from 'lucide-vue-next';
