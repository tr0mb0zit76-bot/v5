...
function syncFromSelected() {
    ...
    form.notes = d.notes ?? '';
    const carrierName = d.carrier_name ?? '';
    const carrierInn = d.carrier_inn ?? '';
    carrierPickedLabel.value = carrierName ? `${carrierName}${carrierInn ? ' · ИНН '+carrierInn : ''}` : '';
    carrierSearch.value = carrierName;
}
