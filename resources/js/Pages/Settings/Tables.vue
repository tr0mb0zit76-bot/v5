...
const groupMap = {
    ...
    track_received_date_customer_request: 'tracking',
    track_received_date_customer_closing: 'tracking',
    track_number_carrier: 'tracking',
    track_sent_date_carrier: 'tracking',
    track_received_date_carrier: 'tracking',
    track_received_date_carrier_request: 'tracking',
    track_received_date_carrier_closing: 'tracking',
...
const paymentScheduleGroupMap = {
    ...
    payment_form: 'finance',
    invoice_number: 'documents',
    payment_run_date: 'finance',
