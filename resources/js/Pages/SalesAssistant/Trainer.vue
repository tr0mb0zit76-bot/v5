<template>
    <div class="min-h-0 flex-1 space-y-6 overflow-y-auto lg:min-h-0">
        <section class="border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <h1 class="mt-1 text-2xl font-semibold text-zinc-900 dark:text-zinc-50">Тренажёр</h1>
            <p class="mt-2 max-w-3xl text-sm text-zinc-500 dark:text-zinc-400">
                Проходите опубликованные сценарии без реального клиента: те же шаги, подсказки и фиксация исхода, что в разделе «Скрипты». Исходы по-прежнему попадают в статистику и помогают команде.
            </p>
            <p
            ...
            >
                ...
                <div class="mt-4 flex flex-1 flex-col justify-end">
                    <button
                        ...
                        type="button"
                        class="inline-flex w-full items-center justify-center rounded-xl border border-sky-800 bg-sky-700 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-sky-800 dark:border-sky-500 dark:bg-sky-600 dark:hover:bg-sky-500"
