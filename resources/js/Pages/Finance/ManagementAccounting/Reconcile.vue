    ...
    <div class="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto">
        ...
        <div class="space-y-3">
            ...
            >
                ...
                <div v-if="line.suggested_order" class="text-sm">
                ...
                >
                    ...
                    <input
                        v-if="allocationForms[line.id].allocation_type === 'operational'"
...
for (const line of props.lines) {
    allocationForms[line.id] = {
        ...
        payment_schedule_id: line.suggested_payment_schedule?.id ?? null,
