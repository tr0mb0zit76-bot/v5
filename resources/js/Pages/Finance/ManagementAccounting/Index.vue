            ...
            <section :class="`${crmPanel} p-5`">
                <div class="flex flex-wrap items-start justify-between gap-3">
                    <div>
                        ...
                        <p class="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
                            10 системных статей (сид / миграция) + статьи из «Бюджетирования» по кнопке ниже.
                ...
                <div class="mt-3 space-y-2">
                    ...
                    <p v-if="categories.length === 0" class="py-4 text-center text-sm text-zinc-500">
                        Статей пока нет. Нажмите «Синхронизировать с бюджетом» или обратитесь к администратору (нужен сидер на сервере).
                    </p>
                </div>
            </section>
        </div>
