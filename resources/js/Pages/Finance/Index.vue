    ...
    <div class="space-y-6">
        <section class="rounded-[28px] border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            <div class="space-y-2">
                ...
                <p class="max-w-3xl text-sm text-zinc-500 dark:text-zinc-400">
                    Работа с движением денег, документами и расчётами по заказам, чтобы держать всё в одном месте,
                    не переключаясь на сторонние инструменты.
                </p>
            </div>
        </section>
        ...
        <section class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <Link
                ...
                class="rounded-[28px] border border-zinc-200 bg-white p-5 text-left shadow-sm transition hover:border-zinc-300 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-zinc-700 dark:hover:bg-zinc-800"
            >
                <div class="text-sm font-semibold text-zinc-900 dark:text-zinc-50">Документы</div>
                <p class="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
                    Чек-листы и истории статусов по счётам, УПД и актам из одного места.
                </p>
            </Link>
            <Link
                ...
                class="rounded-[28px] border border-zinc-200 bg-white p-5 text-left shadow-sm transition hover:border-zinc-300 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-zinc-700 dark:hover:bg-zinc-800"
            >
                <div class="text-sm font-semibold text-zinc-900 dark:text-zinc-50">ДДС</div>
                <p class="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
                    Следите за оплатами, планом, фактом и статусами в реальном времени.
                </p>
            </Link>
        </section>

        <div v-if="activeSubmodule === 'documents'" class="space-y-4">
            ...
            >
                <div class="w-full max-w-lg rounded-[28px] bg-white p-6 shadow-2xl dark:bg-zinc-900">
                    <div class="flex items-center justify-between">
                        ...
                        <button type="button" class="text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-50" @click="closeDocumentModal">Г×</button>
                    </div>
...
const activeSubmodule = ref(props.activeSubmodule === 'dds' ? 'dds' : 'documents');
const tabs = [
