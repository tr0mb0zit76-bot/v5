...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasTable('contractors') && Schema::hasTable('contractor_documents')) {
            ...
            $result = $connection->select("
                ...
                AND TABLE_NAME = 'contractor_documents' 
                AND CONSTRAINT_NAME = 'contractor_documents_contractor_id_foreign'
