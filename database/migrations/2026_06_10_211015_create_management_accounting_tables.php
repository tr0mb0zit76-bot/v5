    ...
    public function up(): void
    {
        ...
        if (! Schema::hasTable('management_statement_lines')) {
            Schema::create('management_statement_lines', function (Blueprint $table): void {
                $table->id();
                $table->foreignId('import_id')->nullable()->constrained('management_statement_imports')->nullOnDelete();
                $table->foreignId('bank_account_id')->constrained('management_bank_accounts')->cascadeOnDelete();
                ...
                $table->foreignId('suggested_order_id')->nullable()->constrained('orders')->nullOnDelete();
                $table->foreignId('suggested_payment_schedule_id')->nullable()->constrained('payment_schedules')->nullOnDelete();
                $table->foreignId('suggested_category_id')->nullable()->constrained('management_expense_categories')->nullOnDelete();
                $table->foreignId('suggested_user_id')->nullable()->constrained('users')->nullOnDelete();
                $table->foreignId('allocation_category_id')->nullable()->constrained('management_expense_categories')->nullOnDelete();
                $table->foreignId('allocation_order_id')->nullable()->constrained('orders')->nullOnDelete();
                $table->foreignId('allocation_payment_schedule_id')->nullable()->constrained('payment_schedules')->nullOnDelete();
                $table->foreignId('allocation_user_id')->nullable()->constrained('users')->nullOnDelete();
