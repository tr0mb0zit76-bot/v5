...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (101,'2026_05_01_120000_add_trainer_ai_role_to_sales_script_play_sessions_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (102,'2026_05_06_120000_create_vat_rates_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (103,'2026_05_06_140000_add_role_id_to_users_when_missing',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (104,'2026_05_10_112158_add_non_resident_correspondent_bank_fields_to_contractors_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (105,'2026_05_10_113009_add_cnaps_code_to_contractors_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (106,'2026_05_10_120000_create_currencies_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (107,'2026_05_10_121156_add_non_resident_corr_settlement_account_to_contractors_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (108,'2026_05_15_100000_add_peer_reaction_to_sales_script_trainer_messages_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (109,'2026_05_16_120000_add_auto_peer_reaction_to_sales_script_trainer_messages_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (110,'2026_06_12_100000_drop_legacy_sites_widgets_and_address_junction_tables',33);
