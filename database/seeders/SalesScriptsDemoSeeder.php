    ...
    public function run(): void
    {
        ...
        $this->seedScript(
            ...
            nodes: [
                ...
                ['client_key' => 'objection_stall', 'kind' => SalesScriptNodeKind::Say, 'body' => 'Понимаю, сейчас не время для длинного разговора. Давайте коротко: что будет удобнее — письмо с тезисами на почту или короткий созвон на 15 минут в удобный слот?', 'hint' => 'Не давите; предложите минимальный следующий шаг.', 'sort_order' => 70],
                ['client_key' => 'objection_competitor', 'kind' => SalesScriptNodeKind::Say, 'body' => 'Логично, что у вас уже есть подрядчик. Я не предлагаю «менять всё сразу». Давайте сравним по одному критерию, который для вас критичен — срок, прозрачность статусов или резерв по перевозчикам. Если разницы нет, честно скажете «не актуально».', 'hint' => 'Признайте текущего игрока, предложите низкорисковый тест.', 'sort_order' => 75],
                ['client_key' => 'objection_price', 'kind' => SalesScriptNodeKind::Say, 'body' => 'По цене без вводных сравнение будет неточным. Давайте зафиксируем 2–3 маршрута и параметры груза — вернусь с вилкой и пояснением, из чего складывается ставка. Так вы сможете сравнить с текущим подрядчиком на одинаковых условиях.', 'hint' => 'Уводите от «скажите цену сейчас» к параметрам расчёта.', 'sort_order' => 78],
            ...
            transitions: [
                ...
                ['from' => 'objection_stall', 'to' => 'next_step', 'reaction' => null],
                ['from' => 'objection_competitor', 'to' => 'criteria_probe', 'reaction' => null],
                ['from' => 'objection_price', 'to' => 'procedure_probe', 'reaction' => null],
                ['from' => 'next_step', 'to' => 'end', 'reaction' => null],
            ],
            reactionIds: $reactionIds,
        );
