...
class Order extends Model
{
    ...
    protected function casts(): array
    {
        $casts = [
            ...
            'track_received_date_customer_request' => 'date',
            'track_received_date_customer_closing' => 'date',
            'track_sent_date_carrier' => 'date',
            'track_received_date_carrier' => 'date',
            'track_received_date_carrier_request' => 'date',
            'track_received_date_carrier_closing' => 'date',
