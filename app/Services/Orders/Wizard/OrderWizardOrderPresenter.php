            ...
            'cargo_items' => $this->hydrateCargoItemsForWizard(
                $this->mergeCargoItemsWithWizardState(
                    $cargoItems->map(fn ($cargo): array => [
                        ...
                        'dimension_unit' => $cargo->dimension_unit ?: 'm',
                        'length_value' => $cargo->length_value ?? $cargo->length,
                        'width_value' => $cargo->width_value ?? $cargo->width,
                        'height_value' => $cargo->height_value ?? $cargo->height,
