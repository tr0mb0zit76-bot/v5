...
class PrintFormPlaceholderPathResolver
{
    ...
    private function legacyPlaceholderMappings(): array
    {
        return [
            ...
            'gruz_1' => 'cargo.line_1_text',
            'gruz_2' => 'cargo.line_2_text',
            'gruz_3' => 'cargo.line_3_text',
            'gruz_4' => 'cargo.line_4_text',
            'gruz_5' => 'cargo.line_5_text',
            'cargo_name2' => 'cargo.line_2_text',
            'cargo_name3' => 'cargo.line_3_text',
            'cargo_name4' => 'cargo.line_4_text',
            'cargo_name5' => 'cargo.line_5_text',
