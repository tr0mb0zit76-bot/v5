...
class PrintFormPlaceholderPathResolver
{
    ...
    private function staticLegacyMappings(): array
    {
        return [
            ...
            'gruzootpravitel' => 'cargo_sender.name',
            ...
            'adres_pogruzki' => 'route.loading_first_address',
            'adres_vygruzki' => 'route.unloading_first_address',
            'kontankt_pogruzka' => 'cargo_sender.contact_phone',
            'kontakt_pogruzka' => 'cargo_sender.contact_phone',
            'gruzootprav_kontakt' => 'cargo_sender.contact_phone',
            'gruzopoluch_kontakt' => 'cargo_recipient.contact_phone',
            'cargo_row_name' => 'cargo.line_1_name',
            'cargo_row_summary' => 'cargo.line_1_summary',
            'cargo_places_weight_volume' => 'cargo.summary',
    ...
    private function prefixedPartyMappings(string $prefix, string $partyRoot): array
    {
        $suffixMap = [
            ...
            'osnovanie' => "{$partyRoot}.signer_authority_basis",
