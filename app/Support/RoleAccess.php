...
class RoleAccess
{
    ...
    public static function visibilityAreaOptions(): array
    {
        return [
            ...
            ['key' => 'modules_how_much_costs', 'label' => 'Модули: «Сколько стоит?»', 'description' => 'Калькулятор ставки по нормам парка (км до/от границы → цена клиенту)'],
    ...
    /**
     * Разнос банковских платежей (вкладка «Разнос платежей» в графике оплат и импорт операций).
     */
