...
class OrderTableColumns
{
    ...
    public static function options(): array
    {
        return [
            ...
            ['field' => 'customer_payment_form', 'label' => 'Оплата клиента', 'width' => 150, 'minWidth' => 120, 'type' => null],
            ['field' => 'customer_payment_term', 'label' => 'Срок клиента', 'width' => 150, 'minWidth' => 120, 'type' => null],
            ...
            ['field' => 'carrier_payment_form', 'label' => 'Оплата перевозчика', 'width' => 180, 'minWidth' => 140, 'type' => null],
            ['field' => 'carrier_payment_term', 'label' => 'Срок перевозчика', 'width' => 180, 'minWidth' => 140, 'type' => null],
            ...
            ['field' => 'status_updated_at', 'label' => 'Статус обновлён', 'width' => 150, 'minWidth' => 130, 'type' => 'datetime'],
            ...
            ['field' => 'track_received_date_customer', 'label' => 'Трек заказчиком получен', 'width' => 210, 'minWidth' => 170, 'type' => 'date'],
            ...
            ['field' => 'track_received_date_carrier', 'label' => 'Трек перевозчиком получен', 'width' => 220, 'minWidth' => 180, 'type' => 'date'],
            ...
            ['field' => 'updated_at', 'label' => 'Обновлён', 'width' => 150, 'minWidth' => 130, 'type' => 'datetime'],
        ];
    }
