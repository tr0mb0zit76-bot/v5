...
class OrderTableColumns
{
    ...
    public static function options(): array
    {
        return [
            ...
            ['field' => 'track_received_date_customer', 'label' => 'Оригиналы заказчика (сводка)', 'width' => 230, 'minWidth' => 190, 'type' => 'date'],
            ['field' => 'track_received_date_customer_request', 'label' => 'Оригиналы заявки заказчика', 'width' => 230, 'minWidth' => 190, 'type' => 'date'],
            ['field' => 'track_received_date_customer_closing', 'label' => 'Оригиналы закрывающих заказчика', 'width' => 250, 'minWidth' => 200, 'type' => 'date'],
            ...
            ['field' => 'track_received_date_carrier', 'label' => 'Оригиналы перевозчика (сводка)', 'width' => 230, 'minWidth' => 190, 'type' => 'date'],
            ['field' => 'track_received_date_carrier_request', 'label' => 'Оригиналы заявки перевозчика', 'width' => 240, 'minWidth' => 190, 'type' => 'date'],
            ['field' => 'track_received_date_carrier_closing', 'label' => 'Оригиналы закрывающих перевозчика', 'width' => 260, 'minWidth' => 200, 'type' => 'date'],
