...
final class OrderAgentLexicon
{
    ...
    public static function entries(): array
    {
        $inline = [
            ...
            'track_received_date_customer' => ['Дата получения оригиналов заказчика', []],
            'track_received_date_customer_request' => ['Дата получения оригиналов заявки заказчика', ['оригиналы заявки заказчика']],
            'track_received_date_customer_closing' => ['Дата получения закрывающих заказчика', ['оригиналы упд заказчика', 'закрывающие заказчика']],
            'track_number_carrier' => ['Трек-номер (перевозчик)', ['трек перевозчика']],
            'track_sent_date_carrier' => ['Дата отправки трека перевозчику', []],
            'track_received_date_carrier' => ['Дата получения оригиналов перевозчика', []],
            'track_received_date_carrier_request' => ['Дата получения оригиналов заявки перевозчика', ['оригиналы заявки перевозчика']],
            'track_received_date_carrier_closing' => ['Дата получения закрывающих перевозчика', ['оригиналы упд перевозчика', 'закрывающие перевозчика']],
