...
final class McpToolDomainRegistry
{
    ...
    private const TOOLS = [
        ...
        'get_lead' => ['domain' => 'leads', 'cross' => ['tasks']],
        'update_lead_field' => ['domain' => 'leads', 'cross' => []],
        'create_lead_next_step' => ['domain' => 'leads', 'cross' => ['tasks']],
        ...
        'get_improvement_loop_insights' => ['domain' => 'analytics', 'cross' => ['leads', 'finance', 'fleet', 'orders']],
        ...
        'list_proposal_html_templates' => ['domain' => 'settings', 'cross' => []],
        'get_proposal_html_template' => ['domain' => 'settings', 'cross' => []],
        'create_proposal_html_template' => ['domain' => 'settings', 'cross' => []],
        'update_proposal_html_template' => ['domain' => 'settings', 'cross' => []],
