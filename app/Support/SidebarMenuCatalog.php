...
final class SidebarMenuCatalog
{
    ...
    public static function labels(): array
    {
        return [
            ...
            'fleet-cost-norms' => 'Нормы себестоимости',
    ...
    public static function isKeyAccessibleForAreas(string $key, array $areas, User $user): bool
    {
        ...
        return match ($key) {
            ...
            'fleet-cost-norms' => RoleAccess::hasVisibilityArea($areas, 'own_fleet'),
            'documents' => isset($areaSet['documents']),
            'epd' => isset($areaSet['documents']) || isset($areaSet['orders']),
            ...
            'improvement' => isset($areaSet['reports']) && CrmFeatureCatalog::isEnabled('improvement_loop', $user),
