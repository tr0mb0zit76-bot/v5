...
#[Name('validate_sales_script_graph')]
#[Description('Проверка графа скрипта: стартовый и недостижимые узлы, дубли реакций, отсутствующие живые фразы и ненастроенное направление разговора.')]
class ValidateSalesScriptGraphTool extends Tool
{
    ...
    public function handle(Request $request): Response
    {
        return $this->withMcpAccess($request, function (User $user) use ($request): Response {
            ...
            try {
                return Response::json($this->salesScripts->validate(
                    $user,
