...
class StoreContractorRequest extends FormRequest
{
    ...
    protected function baseRules(): array
    {
        return [
            ...
            'contacts.*.phones.*.number' => ['nullable', 'string', 'max:50'],
            'contacts.*.phones.*.kind' => ['nullable', 'string', Rule::in(['work', 'personal', 'mobile', 'other'])],
            'contacts.*.phones.*.is_primary' => ['nullable', 'boolean'],
