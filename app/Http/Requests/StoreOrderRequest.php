...
class StoreOrderRequest extends FormRequest
{
    ...
    protected function baseRules(): array
    {
        return [
            ...
            'cargo_sender_name' => ['nullable', 'string', 'max:255'],
            'cargo_sender_address' => ['nullable', 'string', 'max:500'],
            'cargo_sender_contact' => ['nullable', 'string', 'max:255'],
            'cargo_sender_phone' => ['nullable', 'string', 'max:50'],
            'cargo_recipient_name' => ['nullable', 'string', 'max:255'],
            'cargo_recipient_address' => ['nullable', 'string', 'max:500'],
            'cargo_recipient_contact' => ['nullable', 'string', 'max:255'],
            'cargo_recipient_phone' => ['nullable', 'string', 'max:50'],
