...
class StoreOrderRequest extends FormRequest
{
    ...
    protected function baseRules(): array
    {
        return [
            ...
            'cargo_items.*.dimension_unit' => ['nullable', Rule::in(['m', 'cm', 'mm'])],
            'cargo_items.*.length_value' => ['nullable', 'numeric', 'min:0'],
            'cargo_items.*.width_value' => ['nullable', 'numeric', 'min:0'],
            'cargo_items.*.height_value' => ['nullable', 'numeric', 'min:0'],
            ...
            'financial_term.client_payment_schedule.installments' => ['nullable', 'array', 'max:'.PaymentInstallmentScheduleNormalizer::MAX_INSTALLMENTS],
            ...
            'financial_term.contractors_costs.*.payment_schedule.installments' => ['nullable', 'array', 'max:'.PaymentInstallmentScheduleNormalizer::MAX_INSTALLMENTS],
            ...
            'financial_term.additional_costs.*.payment_schedule.installments' => ['nullable', 'array', 'max:'.PaymentInstallmentScheduleNormalizer::MAX_INSTALLMENTS],
