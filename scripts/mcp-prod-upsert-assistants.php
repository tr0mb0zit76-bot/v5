...
/**
 * Publish assistants guide + order/basic-terms regulation to prod Sales Book via MCP.
 * Usage: php scripts/mcp-prod-upsert-assistants.php
 */
...
function prepareBookMarkdown(string $path): string
{
    ...
    $replacements = [
        ...
        '[Регламент оформления заявки и изменения условий](order-application-basic-terms-regulation.md)' => '«Регламент оформления заявки и изменения базовых условий» (раздел «Регламенты работы»)',
        ...
        '[Документы](documents-user-guide.md)' => '«Документы — инструкция для пользователя»',
        ...
        '[documents-user-guide.md#4-заполнить-из-заявки-заказчика-новый-заказ](documents-user-guide.md#4-заполнить-из-заявки-заказчика-новый-заказ)' => '«Документы — инструкция для пользователя», раздел «Заполнить из заявки заказчика»',
    ];
...
$articles = array_values(array_filter([
    [
        ...
        'title' => 'Ассистенты CRM',
        'path' => dirname(__DIR__).'/docs/ai-assistants-user-guide.md',
    ],
    [
        'parent_title' => 'Регламенты работы',
        'title' => 'Регламент оформления заявки и изменения базовых условий',
        'path' => dirname(__DIR__).'/docs/order-application-basic-terms-regulation.md',
    ],
